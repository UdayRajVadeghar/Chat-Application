...
const page = async () => {
  ...
  return (
    <div className="flex h-screen w-full">
      <div className="flex-1 flex overflow-hidden dark:bg-[#651c2b65] bg-[#651c2b] relative justify-center items-center">
        <img
          src="/redis-logo.svg"
          alt="redis-logo"
          className="absolute -left-1/4 opacity-25 -bottom-52 lg:scale-125 xl:scale-100 pointer-events-none select-none -z-1"
        />
        <div className="flex flex-col gap-2 px-4 xl:ml-40 text-center md:text-start font-semibold">
          ...
          <p className="text-2xl md:text-3xl mb-32 txt-balance z-10">
            You{" "}
            <span className="bg-green-500 opacity-90 font-bold px-2 text-white">
              Need To
            </span>
            build
          </p>
